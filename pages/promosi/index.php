...
// Ambil data promosi
$data = mysqli_query($conn,"SELECT * FROM promosi ORDER BY id DESC");
?>

<!DOCTYPE html>
<html>
<head>
    <title>Promosi - RamalToko</title>
...
<!-- CONTENT -->
<div class="content">
    <h2><i class="fa fa-percent"></i> Data Promosi</h2>
    <a href="tambah.php" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah Promosi</a>
...
while($d = mysqli_fetch_assoc($data)){
    $status_class = ($d['status'] == 'aktif') ? 'success' : 'secondary';
?>
                <tr>
                    <td><?= $no++ ?></td>
                    ...
                    <td><span class="badge bg-<?= $status_class ?>"><?= htmlspecialchars($d['status']) ?></span></td>
                    <td>
