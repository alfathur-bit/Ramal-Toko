...
// Ambil data promosi
$id = $_GET['id'];
$data = mysqli_query($conn, "SELECT * FROM promosi WHERE id = $id");
...
if(isset($_POST['update'])){
    ...
    mysqli_query($conn, "UPDATE promosi SET nama='$nama', deskripsi='$deskripsi', diskon_persen='$diskon_persen', tanggal_mulai='$tanggal_mulai', tanggal_akhir='$tanggal_akhir', status='$status' WHERE id=$id");
...
<html>
<head>
    <title>Edit Promosi - RamalToko</title>
...
<!-- CONTENT -->
<div class="content">
    <h2><i class="fa fa-edit"></i> Edit Promosi</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST">
                ...
                <div class="mb-3">
                    <label>Diskon (%)</label>
                    <input type="number" name="diskon_persen" class="form-control" min="0" max="100" value="<?= $d['diskon_persen'] ?>" required>
                </div>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="tanggal_akhir" class="form-control" value="<?= $d['tanggal_akhir'] ?>" required>
                    </div>
                </div>
                <div class="mb-3">
                    <label>Status</label>
