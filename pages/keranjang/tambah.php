...
if(isset($_POST['simpan'])){
    ...
    mysqli_query($conn, "INSERT INTO keranjang (pelanggan_id, produk_id, jumlah) VALUES ('$pelanggan_id', '$produk_id', '$jumlah')");
...
<html>
<head>
    <title>Tambah ke Keranjang - RamalToko</title>
...
<!-- CONTENT -->
<div class="content">
    <h2><i class="fa fa-plus"></i> Tambah ke Keranjang</h2>
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="produk_id" class="form-select" required>
                        ...
                        <option value="<?= $pr['id'] ?>"><?= htmlspecialchars($pr['nama']) ?> - Rp <?= number_format($pr['harga'], 0, ',', '.') ?></option>
                        <?php endwhile; ?>
                    </select>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" name="simpan" class="btn btn-primary"><i class="fa fa-save"></i> Tambah</button>
